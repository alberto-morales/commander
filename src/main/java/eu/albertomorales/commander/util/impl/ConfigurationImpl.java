...
import eu.albertomorales.commander.model.impl.EnvironmentDefImpl;
import eu.albertomorales.commander.model.impl.ServerDefImpl;
...
public class ConfigurationImpl implements Configuration {
	...
	/* (non-Javadoc)
	 * @see eu.albertomorales.commander.util.Configuration#getServerDefinitions()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.albertomorales.commander.util.Configuration#getEnvironmentDefinitions()
	 */
	@Override
	...
	private String getConfigFilePath() {
		return System.getProperty("eu.albertomorales.commander.config-file", "commander-config.xml");
	}
